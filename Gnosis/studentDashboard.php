    ...
    <section >
        <div class="container-fluid">
           ...
           <div class="admin-section">
               <div class="row " >
                  <div class="col-md-2 col-xxl-2 col-sm-2 col-lg-2  p-0">
                   <?php
              ...
              <div class="col-md-12 col-xxl-12 col-lg-12 col-sm-12 mb-auto p-3 d-flex justify-content-center">
    ...
    while($row=mysqli_fetch_assoc($data_sharing))
    {
        ...
        ?>
                        ...
                        <td class='serial'><?php echo $count?></td>
                            <td><img class='book-img' src="image/<?php echo $picture?>" alt="book not found"></td>
